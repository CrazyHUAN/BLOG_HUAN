...
module.exports = {
    ...
    icons: [
      {
        ...
        title: '发邮件',
        link: 'mailto:cun_huan@126.com'
      },
      {
        iconClass: 'icon-github',
        title: 'GitHub',
        link: 'https://github.com/CrazyHUAN'
      },
      // {
      //   iconClass: 'icon-erji',
      //   title: '听音乐',
  ...
  footer: {// 页脚信息
    ...
    copyrightInfo: 'CrazyHuan | <a href="https://github.com/CrazyHUAN/BLOG_HUAN/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
  },
